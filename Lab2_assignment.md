...
``` r
acs_vars <- c( "B08014_002", # Estimate!!Total:!!No vehicle available
               "B08141_016") # Estimate!!Total:!!Public transportation to work (excluding taxicab)

myTracts <- c("42101016100",
              "42101016000",
              "42101015800",
              "42101015700")
...
acsTractsPHL.2019.sf <- get_acs(geography = "tract",
  ...
  rename (total_no_vehicle = B08014_002E,
          total_transit_to_work = B08141_016E) %>%
