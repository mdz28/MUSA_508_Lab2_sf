...
ggplot()+
  geom_sf(data = acsTractsPHL.2019.sf, aes(fill = total_transit_to_work),
          color = "transparent")+
  ...
  labs(
    title = "Raw Number of People Who Take Transit to Work",
    subtitle = "Special Focus on Fishtown, Philadelphia",
